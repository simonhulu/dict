...
<!-- modal -->
<form id="addform" action="/addDic" method="post" enctype="multipart/form-data">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <!-- <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">注释(汉语)</span>
            <input type="text" name="comment" class="form-control" placeholder="藏语内容" >
          </div>
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">注释(藏语)</span>
            <input type="text" name="tibetcomment" class="form-control" placeholder="藏语内容" >
          </div>
          <div class="input-group">
...
<form id="adddicsExcel" action="/addDics" method="post" enctype="multipart/form-data">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                for(int i = 0 ;i<phrases.size();i++)
                {
                	...
                	phrase.getComment()+"</td><td>"+
                	phrase.getTibetComment()+"</td>"+
                	"<td><audio style='width:40px' controls src= "+phrase.getAudioPath()+" /audio></td>"+
                	"<td><audio style='width:40px' controls src= "+phrase.getTibetAudioPath()+" /audio></td></tr>");
                }
                %>
...
$(document).ready(function(){
	...
	var pn = getParameterByName('pn'); 
	 ...
	 $("form#adddicsExcel").submit(function(e) {
